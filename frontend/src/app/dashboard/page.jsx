...
const statsData = [
  ...
  },
  {
    ...
    chartConfig: { performance: { label: "Rendimiento", color: "#3b82f6" } },
  },
  {
    label: "Win Rate",
    percentage: 68,
    ...
    chartConfig: { winRate: { label: "Win Rate", color: "#f59e0b" } },
  },
];

return (
  <section className="text-black dark:text-white size-full grid gap-5 max-md:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:grid-rows-2 [&>article]:bg-[#0c111000] [&>article]:border [&>article]:border-alt-dark-primary-border [&>article]:p-4 [&>article]:rounded-lg [&>article]:size-full [&>article]:md:overflow-y-auto [&>article]:dark:bg-alt-dark-primary-color/5">
    <article className="lg:col-span-1">
        ...
        <div className="space-y-2">
          <div className="font-sans font-bold text-lg flex items-center gap-2">
            <button
              ...
              type="submit"
              className="block size-fit rounded-md p-2 text-alt-dark-blue dark:bg-alt-dark-primary-color/20 hover:bg-alt-light-primary-color/50 hover:dark:bg-alt-dark-blue/40 transition-all cursor-pointer outline-none"
            >
              {isBalanceHidden ? (
      ...
      <main className="pt-4">
            ...
            >
              ...
              <div className="flex items-center gap-3 w-full min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-difuminate-text-light dark:text-difuminate-text-dark truncate">
                    {transaction.date} ·{" "}
                    {transaction.method
                      ? transaction.method
                      : `A: ${transaction.to}`}
              ...
              <div className="flex flex-col sm:items-end w-full sm:w-auto">
                <span className="text-black dark:text-white text-sm font-semibold font-sans">
        ...
        <div className="flex items-center justify-center gap-2 pt-4 [&>button]:w-fit [&>button]:p-2 [&>button]:rounded-md [&>button]:bg-alt-light-primary-color/50 [&>button]:dark:bg-alt-dark-blue/20 transition-all">
          <button
            type="button"
          ...
          <div className="space-x-4 [&>span]:inline-block">
            <span className="text-primary-color dark:text-alt-dark-blue">
              1
            </span>
            <span>2</span>
            <span>3</span>
    ...
    <article className="lg:col-span-2 flex flex-col justify-between">
      ...
      <ChartContainer config={chartConfig} className="h-[60%]">
        ...
        >
          <CartesianGrid
            vertical={false}
            stroke={theme === "dark" ? "#2d2d33" : "#bcbcc3"}
          />
          <XAxis
            dataKey="month"
            tickLine={false}
    ...
    <article className="lg:col-span-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-5">
        {statsData.map((stat, index) => (
          <div
            key={index}
            className="bg-alt-light-primary-color/25 dark:bg-alt-dark-primary-color/10 p-4 rounded-lg flex justify-between items-center gap-4 w-full"
          >
            ...
            <ChartContainer config={stat.chartConfig} className="size-[80px]">
              ...
              >
                ...
                <RadialBar
                  dataKey="value"
                  fill={stat.progressColor}
                  background={{
                    fill: theme === "light" ? "#000" : "#2d3748",
                    opacity: 0.8,
                  }}
                  cornerRadius={50}
                  clockWise
    ...
    <article className="lg:col-span-1">
      ...
      <ul className="pt-5 space-y-4">
        {recentTrades.map((trade, index) => (
          <li
            key={index}
            className="flex flex-col justify-between gap-3 sm:gap-4 border-b border-gray-400 dark:border-gray-700 pb-3"
          >
            <div className="flex justify-between items-center">
      ...
      <div className="flex items-center justify-center gap-2 pt-4 [&>button]:w-fit [&>button]:p-2 [&>button]:rounded-md [&>button]:bg-alt-light-primary-color/50 [&>button]:dark:bg-alt-dark-blue/20 transition-all">
        ...
        <div className="space-x-4 [&>span]:inline-block">
          <span className="text-primary-color dark:text-alt-dark-blue">1</span>
          <span>2</span>
          <span>3</span>
        </div>
