...
export default {
  ...
  theme: {
  	...
  	backgroundImage: {
  		...
  		'gradient-dark-section': 'linear-gradient(180deg,rgba(14, 14, 16, 1) 0%, rgba(29, 29, 31, 1) 100% 100%)',
  		'gradient-light-section': 'linear-gradient(180deg,rgba(23, 163, 75, 0.1) 0%,rgba(32, 98,142, 0.1) 100%)'
  	},
  	animation: {
